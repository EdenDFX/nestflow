    ...
    <AnimatePresence initial={false}>
      {total > 0 ? (
        <motion.span
          ...
          aria-hidden
          className={cn(
            "pointer-events-none absolute z-10 grid place-items-center rounded-full text-primary-foreground",
            COLORS[color],
          )}
          style={{
            top: inset,
        ...
        >
          {!dot ? (
            <span
              className="flex font-semibold leading-none tracking-tight text-primary-foreground"
...
export function NotificationBell({
  ...
  return (
    <button
      ...
      data-slot="notification-bell"
      className={cn(
        "relative grid shrink-0 place-items-center rounded-full outline-none transition-[transform,background-color,color] active:scale-90 focus-visible:ring-2 focus-visible:ring-ring motion-reduce:active:scale-100",
        SURFACE,
        className,
      )}
