...
type DrawerPosition = "right" | "left" | "top" | "bottom" | "center";
      ...
      <DrawerViewport position={position} variant={variant}>
        <DrawerPrimitive.Popup
          className={cn(
            ...
            position === "center" &&
              "max-h-[min(90dvh,calc(100%-2rem))] w-[calc(100%-2rem)] max-w-2xl rounded-2xl border shadow-lg/5 data-ending-style:scale-95 data-ending-style:opacity-0 data-starting-style:scale-95 data-starting-style:opacity-0 transition-[transform,opacity] duration-300",
            variant !== "straight" &&
              cn(
